...
import com.artingl.easyrg.Commands.Runners.SelOutlineCommandRunner;
...
public class CommandSelection implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ChatUtils.sendDecoratedMessage(sender, PluginMain.instance.getLanguage().getString("not-enough-arguments-provided"));
            return false;
        }
        ...
        else if (args[0].equals("outline")) return RunnerRegistry.commandsList.execute(SelOutlineCommandRunner.class, player, args, Permissions.COMMAND_SELECTION_OUTLINE);
